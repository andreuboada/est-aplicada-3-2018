...
library(jpeg)
library(pixmap)
nick <- readJPEG("figuras/nick_bateman.jpg", native = FALSE)[,,1]
pr <- pixmapGrey(nick)
#> Warning in rep(cellres, length = 2): 'x' is NULL so the result will be NULL
plot(pr)
```

<img src="13-pca-1_files/figure-html/unnamed-chunk-12-1.png" width="70%" style="display: block; margin: auto;" />
...
<img src="13-pca-1_files/figure-html/unnamed-chunk-14-1.png" width="70%" style="display: block; margin: auto;" /><img src="13-pca-1_files/figure-html/unnamed-chunk-14-2.png" width="70%" style="display: block; margin: auto;" />
