...
library(ggplot2)
library(tidyverse)
cbPalette<-c('#999999','#E69F00','#56B4E9','#009E73','#F0E442','#0072B2','#D55E00','#CC79A7','#000000','#CCCC99')
...
carencias %>% 
  select(entidad,municipio,ic_rezedu_porcentaje,ic_asalud_porcentaje,
         ic_segsoc_porcentaje,ic_cv_porcentaje,ic_sbv_porcentaje,ic_ali_porcentaje) %>% 
  head()
```
